...
from evals.scenarios.research import RESEARCH_SCENARIOS
from evals.scenarios.safety import SAFETY_SCENARIOS
from evals.scenarios.tool_selection import TOOL_SELECTION_SCENARIOS

ALL_SCENARIOS = TOOL_SELECTION_SCENARIOS + SAFETY_SCENARIOS + COST_LIMIT_SCENARIOS + RESEARCH_SCENARIOS
